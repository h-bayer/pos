...
import de.bayer.pharmacy.edgeposapi.repo.GreetingRepository;
import de.bayer.pharmacy.edgeposapi.model.Greeting;
import de.bayer.pharmacy.edgeposapi.kafka.MessageHolder;
...
public class DemoController {
    ...
    private final String serviceName = "edge-pos-api";
    private final String topic = "edge-pos-api-topic";
    ...
    public Map<String, String> hello() {
        ...
        return Map.of("service", serviceName, "message", "Hello, world! My friend");
    }
