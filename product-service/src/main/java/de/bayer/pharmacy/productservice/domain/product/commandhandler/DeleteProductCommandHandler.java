...
@Component
public class DeleteProductCommandHandler implements ICommandHandler<DeleteProductCommand, Void> {

    private final ProductRepository repo;
    private final IProductFactory productFactory;
    private final ApplicationEventPublisher publisher;

    public DeleteProductCommandHandler(ProductRepository repo, IProductFactory productFactory, ApplicationEventPublisher publisher) {
        this.repo = repo;
